...
export interface ChatbotUIContext {
  // PROFILE STORE
  ...
  isProUser: boolean;
  setIsProUser: Dispatch<SetStateAction<boolean>>;
  ...
  setFileItems: Dispatch<SetStateAction<Tables<"file_items">[]>>;
  ...
  openaiAssistants: any[]; // Considere tipar corretamente
