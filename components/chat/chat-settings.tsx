...
export const ChatSettings: FC<ChatSettingsProps> = ({}) => {
  ...
  return (
    <Popover>
      ...
      <PopoverContent
        className="border-input relative flex max-h-[calc(100vh-60px)] w-[300px] flex-col space-y-4 overflow-auto rounded-lg border-2 bg-background p-6 sm:w-[350px] md:w-[400px] lg:w-[500px] dark:border-none"
        align="end"
      >
        <ChatSettingsForm
